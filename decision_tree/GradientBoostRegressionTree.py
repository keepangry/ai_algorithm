...
class GBRT(object):
    ...
    def __init__(self, learning_rate=1, subsample=1, n_estimators=10, min_samples_split=3, max_depth=2):
...
if __name__ == "__main__":
    ...
    gbrt = GBRT(max_depth=2, min_samples_split=3, n_estimators=10)
    gbrt.fit(X, y)
